defmodule MeilisearchNd.Settings.SearchCutoffMs do
  @moduledoc """
  [Documentation](https://www.meilisearch.com/docs/reference/api/settings#search-cutoff)
  """
  alias MeilisearchNd.{
    Client,
    Http
  ...
  @spec update(Client.t(), String.t(), integer()) :: Http.response()
